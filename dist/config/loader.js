...
export function loadConfig() {
    const config = {
        ...
        pyramidMarkdownFile: core.getInput('pyramid-markdown-file') || 'docs/testing/pyramid-snapshot.md',
        pyramidJsonFile: core.getInput('pyramid-json-file') || 'docs/testing/pyramid-snapshot.json',
        pyramidGatesJsonFile: core.getInput('pyramid-gates-json-file') || 'docs/testing/pyramid-quality-gates.json',
