...
environments = json.loads((root / "report/widgets/environments.json").read_text())
assert environments == [
    {"id": "default", "name": "default"},
    {"id": "module-a", "name": "module-a"},
    {"id": "module-b", "name": "module-b"},
]
default_variables = json.loads((root / "report/widgets/default/variables.json").read_text())
module_a_variables = json.loads((root / "report/widgets/module-a/variables.json").read_text())
module_b_variables = json.loads((root / "report/widgets/module-b/variables.json").read_text())
